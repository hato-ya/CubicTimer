 ...
 * @author damo
 */
public abstract class AverageCalculatorSuper {
     ...
     * in disqualification.
     */
    protected static final int MIN_N_TO_ALLOW_ONE_DNF = 5;
     ...
     */
    protected final boolean mDisqualifyDNFs;
    ...
    protected double mVarianceDelta = 0;
    protected double mVarianceDelta2 = 0;
    protected double mVarianceM2 = 0;
     ...
     */
    protected long mCurrentBestTime;
     ...
     */
    protected long mCurrentWorstTime;
     ...
     */
    protected long mCurrentAverage;
     ...
     */
    protected long mAllTimeBestTime;
     ...
     */
    protected long mAllTimeWorstTime;
     ...
     */
    protected long mAllTimeBestAverage;

    /**
     * The best average is updated or not
     */
    protected boolean mIsAllTimeBestAverageUpdated = false;
     ...
     */
    protected void updateDNFCounts(long addedTime, long ejectedTime) {
        if (addedTime == DNF) {
            mNumCurrentDNFs++;
            mNumAllTimeDNFs++;
        }
     ...
     *     Use {@link #UNKNOWN} if no old time was ejected.
     */
    protected void updateCurrentBestAndWorstTimes(long addedTime, long ejectedTime) {
    ...
    protected abstract void updateCurrentTrims(long addedTime, long ejectedTime);
     ...
     */
    protected void updateSums(long addedTime, long ejectedTime) {
        if (addedTime != DNF) {
     ...
     */
    protected void updateVariance(long addedTime) {
     ...
     */
    protected void updateCurrentAverage() {
        if (mNumSolves < mN) {
     ...
     * calling this method.
     */
    protected void updateAllTimeBestAndWorstTimes() {
     ...
     */
    protected abstract void updateAllTimeBestAverage();
     ...
     * parameter to {@link #AverageCalculatorSuper(int, int)}). If DNFs are allowed, then the
    ...
    /**
     * Gets recent(all) times of AverageCalculatorSuper
    ...
    public static long tr(long time) {
        if (time == UNKNOWN) {
            return PuzzleUtils.TIME_UNKNOWN;
        }
        if (time == DNF) {
    ...
    public static class AverageOfN {
        ...
        * many DNF solves, or {@link #UNKNOWN} if the are too few times (less than "N").
         ...
         */
        private AverageOfN(AverageCalculatorSuper ac) {
            final int n = ac.getN();
