...
import static com.hatopigeon.cubictimer.utils.TTIntent.ACTION_STATISTICS_LOADED;
import static com.hatopigeon.cubictimer.utils.TTIntent.ACTION_TIMES_MODIFIED;
import static com.hatopigeon.cubictimer.utils.TTIntent.ACTION_TIMES_MOVED_TO_HISTORY;
...
public class StatisticsLoader extends AsyncTaskLoader<Wrapper<Statistics>> {
    ...
    public Wrapper<Statistics> loadInBackground() {
        ...
        CubicTimer.getDBHandler().populateStatistics(mPuzzleType, mPuzzleSubtype, mStatistics);
