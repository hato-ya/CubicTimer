...
public final class TTIntent {
     ...
     * any system names.
     */
    private static final String BASE_PREFIX = "com.hatopigeon.cubictimer.";
    ...
    public static void registerReceiver(BroadcastReceiver receiver, String category) {
        ...
        LocalBroadcastManager.getInstance(CubicTimer.getAppContext())
    ...
    public static void unregisterReceiver(BroadcastReceiver receiver) {
        LocalBroadcastManager.getInstance(CubicTimer.getAppContext()).unregisterReceiver(receiver);
    }
    ...
    public static class BroadcastBuilder {
        ...
        public void broadcast() {
            ...
            LocalBroadcastManager.getInstance(CubicTimer.getAppContext()).sendBroadcast(mIntent);
        }
